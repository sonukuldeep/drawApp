...
const Footer = () => {
    return (
        <footer className="py-4 bg-gradient-to-r from-[#5cbf96] to-[#49aab7]">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
                    <div className="xl:flex xl:items-center xl:justify-start">
                        <img className="w-auto mx-auto h-7" src={logo} alt="Logo" />

                        <p className="mt-5 text-sm text-white xl:ml-6 xl:mt-0">© Copyright 2022 Eastern dev</p>
                    </div>
